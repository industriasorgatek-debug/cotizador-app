...
# -------------------------------------------------------------------------
    ...
    st.write("Registra pagos multimoneda con conversión precisa a USD, cálculo de comisiones (flat y %), desglose de Gran Total y exportación a Excel / CSV / PDF.")
    ...
    # ------------------ SECCIÓN 2: HISTORIAL Y REPORTES ------------------
        ...
        if not transferencias:
            ...
            # SECCIÓN DE DESCARGA (EXCEL, CSV Y PDF)
            ...
            if not df_tf.empty:
                ...
                # 3. Botón PDF (Exporta solo lo que está filtrado)
                try:
